...
| 1.3 Discharge readiness API | A | 🔵 **2 of 4 endpoints** | ✅ `GET .../discharge-readiness` · ✅ `POST .../discharge-contracts` (bulk, atomic, UNIQUE(order_id) race proven). ⬜ **remaining: POST discharge, POST discharge-overrides** |
